...
<body>
	...
	$consulta=("SELECT * FROM registro_patrimonio WHERE idRegistro='$idProducto'");
...
?>
			...
			<div class="col-12 col-md-4 col-sm-12">
				<div class="card">
					...
					<div class="card-body">
					<b><span><?php echo $f['Descripcion'];?></span></b><br>
					<span><strong>Descripcion:</strong><?php echo $f['Observacion'];?></span><br>
					<span>Codigo:<?php echo $f['Cod_Distrito'];?></span><br>
					</div>
    				</div>
			</div>
