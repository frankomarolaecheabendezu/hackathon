...
<body>
		...
		<div class="collapse navbar-collapse" id="navbar">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active">
						<a href="listarSolicitudes.php" class="nav-link">Listar Solicitudes</a>
					</li>
					<li class="nav-item">
	...
	$consulta="SELECT * FROM solicitud ORDER BY IdSolicitud ASC";
...
?>
			<div class="col-12 col-md-4 col-sm-12">
				...
				<div class="card">
					...
					<input type="text" name="quantity" disabled="true" class="form-control" value="<?php echo $f['Nombres'];?>"/>
					<input type="text" name="quantity" disabled="true" class="form-control" value="<?php echo $f['Ubicacion'];?>"/>
					<input type="hidden" name="hidden_nombre" value="<?php echo $f['Nombres'];?>"/>
					<input type="hidden" name="hidden_precio" value="<?php echo $f['Fecha'];?>"/>
					</div>					
					<a href="DetalleSolicitud.php?id=<?php echo $f['IdSolicitud'];?>" class="btn btn btn-warning btn-lg btn-block">Atender Solicitudes
